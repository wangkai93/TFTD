...
public class TipsActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setWebViewContentFromAssets(study_readings_webView,
				getString(R.string.study_readings_html_url));
		setWebViewContentFromAssets(ec_materials_webView,
				getString(R.string.ec_materials_html_url));
		...
		studyReadingsButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				studyReadingsButton.setBackgroundDrawable(getResources()
						.getDrawable(R.drawable.switch_tab_btn_bg_left_press));
				// ecMaterialsButton.setBackgroundDrawable(getResources().getDrawable(R.drawable.right_button_white));
				ecMaterialsButton.setBackgroundDrawable(null);
				studyReadingsButton.setTextColor(Color.WHITE);
				ecMaterialsButton.setTextColor(getResources().getColor(
		...
		ecMaterialsButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				studyReadingsButton.setBackgroundDrawable(null);
				ecMaterialsButton.setBackgroundDrawable(getResources()
						.getDrawable(R.drawable.switch_tab_btn_bg_right_press));
				studyReadingsButton.setTextColor(getResources().getColor(
						R.color.switch_tab_blue_bg));
		 ...
		 study_readings_webView.setWebViewClient(mWebViewClient);
		 ec_materials_webView.setWebViewClient(mWebViewClient);

	}

	public void getRemainingComponentInstance() {
		tipsRL = (RelativeLayout) findViewById(R.id.tips);
		tipsRL.setBackgroundDrawable(new BitmapDrawable(ReadBitmapUtil
				.readBitMap(this, R.drawable.howtouse_bg)));
	...
	protected void onPause() {
		super.onPause();
		while(study_readings_webView.canGoBack()) {
			study_readings_webView.goBack();
		}
		while(ec_materials_webView.canGoBack()) {
			ec_materials_webView.goBack();
		}
	}
