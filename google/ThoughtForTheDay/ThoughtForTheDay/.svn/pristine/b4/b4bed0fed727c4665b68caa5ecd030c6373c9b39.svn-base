...
//		}
	...
	private void setDataForReadingView(){
		...
		content = "<html><head><style type='text/css'>p{color:white;font-size:"+bodySize+"px;font-family:Times New Roman,Times,serif;text-align:center;text-shadow:1px 1px 2px #000000;}</style></head><body><p style='font-size:"+titleSize+"px;font-family:Times New Roman,Times,serif;text-align:center;'>"+selectedItemTitle+"</p>"+selectedItemBody+"</body></html>"; 
