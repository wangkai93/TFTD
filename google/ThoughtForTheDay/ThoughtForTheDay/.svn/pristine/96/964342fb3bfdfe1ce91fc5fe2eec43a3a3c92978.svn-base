...
public class ServerManagedPolicy implements Policy {
    ...
    //samuel.cai add... 
    private static final String LICENSED_DEFAULT_VALIDITY_TIMESTAMP = Long.toString(System.currentTimeMillis() + (MILLIS_PER_MINUTE * 60L * 24L * 7L));
    ...
    public void processServerResponse(int response, ResponseData rawData) {
        ...
        if (response == Policy.LICENSED) {
          ...
          //  setValidityTimestamp(extras.get("VT"));
            setValidityTimestamp(LICENSED_DEFAULT_VALIDITY_TIMESTAMP); //set 7 days valiable timestamp for Licensed user... 
