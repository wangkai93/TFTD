...
//    private String attachment="{\"name\":\"Jacobs Alumni School\",\"href\":\""+"http://www.jacobsschool.ucsd.edu/"+"\"," 
//    +"\"description\":\"Jacobs School History: Youngest of the Best!\","
//    +"\"media\":[{\"type\":\"image\",\"src\":\"http://www.jacobsschool.ucsd.edu/assets/images/logo_jacobsschool.gif"
//	+"\",\"href\":\""+"http://www.jacobsschool.ucsd.edu/"+"\"}]"+"}";
    //public PostFacebookItem postFacebookItem;

	public String setAttachment(PostFacebookItem post) {
		this.attachment = "{\"name\":\""+post.getTitle()+"\",\"href\":\""+post.getUrl()+"\","		   
	    +"\"description\":\""+post.getBody()+"\","
	    +"\"media\":[{\"type\":\"image\",\"src\":\""+ post.getIcon_src() + ""
		+"\",\"href\":\""+post.getUrl()+"\"}]"+"}";
		return attachment;
	}
...
//                Log.d("Facebook-authorize", "Login cancelled");
    ...
    public String logout(Context context) 
    	...
    	ConstantUtil.fb_is_login = false;
//    	System.out.println(".............fb logout...");
    ...
    public String request(String graphPath,
        ...
        parameters.putString(TOKEN, "155964484493048|K64d6A-aUuinrKUGPL7svZlQvxg");
    ...
    public void dialog(Context context, 
        ...
        parameters.putString("attachment", getAttachment());
        if (isSessionValid()) {
            parameters.putString(TOKEN, getAccessToken());
        }
